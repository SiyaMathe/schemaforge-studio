...
-- Explicitly force standard connection behaviors to prevent structural deployment failures
...
-- Re-verify standard environment properties inside the updated database context
SET QUOTED_IDENTIFIER ON;
SET ANSI_NULLS ON;
GO
...
(
    ...
    -- self-referencing for subcategory tree
